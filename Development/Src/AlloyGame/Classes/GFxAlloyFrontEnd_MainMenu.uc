...
Filename    :   GFxAlloyFrontEnd_MainMenu.uc
...
**********************************************************************/
class GFxAlloyFrontEnd_MainMenu extends GFxAlloyFrontEnd_Screen
	config(UI);
...
{
	local GFxAlloyFrontEnd_InfoDialog ExitDialogMC;
	ExitDialogMC = GFxAlloyFrontEnd_InfoDialog(MenuManager.SpawnDialog('InfoDialog')); 
...
event bool WidgetInitialized(name WidgetName, name WidgetPath, GFxObject Widget)
{
	...
	//`log("GFxAlloyFrontEnd_MainMenu: WidgetInitialized():: WidgetName: " @ WidgetName @ " : " @ WidgetPath @ " : " @ Widget);     
	switch(WidgetName)
	{
		case ('list'):  
			if (ListMC == none)
