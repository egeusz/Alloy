class AlloyFamilyInfo_BuilderBot extends UTFamilyInfo;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'bb_builderBot.builderBot_mesh'
	...
	PhysAsset=PhysicsAsset'bb_builderBot.builderBot_mesh_Physics'
