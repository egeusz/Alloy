...
Filename    :   GFxAlloyFrontEnd_JoinDialog.uc
...
**********************************************************************/
class GFxAlloyFrontEnd_JoinDialog extends GFxAlloyFrontEnd_Dialog
    config(UI);
...
event bool WidgetInitialized(name WidgetName, name WidgetPath, GFxObject Widget)
{
    ...
    //`log("GFxAlloyFrontEnd_JoinDialog: " @ WidgetName @ " : " @ WidgetPath @ " : " @ Widget);
