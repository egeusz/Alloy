...
Filename    :   GFxAlloyFrontEnd_LaunchGame.uc
...
**********************************************************************/
class GFxAlloyFrontEnd_LaunchGame extends GFxAlloyFrontEnd_Screen
    abstract;
...
{   
    ...
    EnabledMutatorCount = class'GFxAlloyFrontEnd_Mutators'.static.GetNumEnabledMutators();
...
event bool WidgetInitialized(name WidgetName, name WidgetPath, GFxObject Widget)
{
    ...
    //`log("GFxAlloyFrontEnd_LaunchGame: WidgetInitialized():: WidgetName: " @ WidgetName @ " : " @ WidgetPath @ " : " @ Widget);
    switch(WidgetName)
    {
        case ('list'): 
            if (ListMC == none)
