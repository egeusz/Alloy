 ...
 */
class AlloyDataStore_GameSearchPersonal extends UDKDataStore_GameSearchBase
	config(Game)
	abstract;
 ...
 */
var	transient	AlloyDataStore_GameSearch	PrimaryGameSearchDataStore;
...
protected function bool OverrideQuerySubmission( byte ControllerId, OnlineGameSearch Search )
{
	...
	local AlloyGameSearchPersonal HistorySearch;
	local array<string> HistoryList;

	HistorySearch = AlloyGameSearchPersonal(Search);
