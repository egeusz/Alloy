...
Filename    :   GFxAlloyFrontEnd_SettingsBase.uc
...
**********************************************************************/
class GFxAlloyFrontEnd_SettingsBase extends GFxAlloyFrontEnd_Screen
    config(UI);
...
var array<AlloyUIDataProvider_MenuOption> SettingsList;
...
function LoadDataFromStore()
{
    ...
    local AlloyUIDataProvider_MenuOption CurrentOption;
	...
	class'AlloyUIDataStore_MenuItems'.static.GetAllResourceDataProviders(class'AlloyUIDataProvider_MenuOption', ProviderList);
	for (i = ProviderList.length-1; i > -1 ; i--)
	{
        ...
        bIsRelevant = false;
        CurrentOption = AlloyUIDataProvider_MenuOption(ProviderList[i]);
...
function SaveState()
{
    ...
    local AlloyGameSettingsCommon LocalGameSettings;
	local SettingsData SettingsDat;

	LocalGameSettings = AlloyGameSettingsCommon(SettingsDataStore.GetCurrentGameSettings());
...
event bool WidgetInitialized(name WidgetName, name WidgetPath, GFxObject Widget)
{
    ...
    //`log("GFxAlloyFrontEnd_Settings: WidgetInitialized():: WidgetName: " @ WidgetName @ " : " @ WidgetPath @ " : " @ Widget);
    switch(WidgetName)
    {
        case ('list'):  
            if (ListMC == none)
