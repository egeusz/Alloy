...
Filename    :   GFxAlloyFrontEnd_PasswordDialog.uc
...
**********************************************************************/
class GFxAlloyFrontEnd_PasswordDialog extends GFxAlloyFrontEnd_Dialog;    
...
event bool WidgetInitialized( name WidgetName, name WidgetPath, GFxObject Widget )
{
    ...
    // `log("GFxAlloyFrontEnd_PasswordDialog: " @ WidgetName @ " : " @ WidgetPath @ " : " @ Widget);
    switch(WidgetName)
    {
        case ( 'item1' ):
